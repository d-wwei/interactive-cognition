...
If other cognitive bases (First Principles, Systems Thinking, etc.) are already in your `AGENTS.md`, place Interactive Cognition AFTER them. Order:
1. Internal reasoning bases (First Principles, Systems Thinking, etc.)
2. Interactive Cognition (inter-personal reasoning layer)
